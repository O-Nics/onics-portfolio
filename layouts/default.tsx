  ...
  return (
    <SearchProvider>
      <div className="relative flex flex-col min-h-screen">
        ...
        <footer className="w-full flex flex-col md:flex-row items-center justify-between py-4 px-5 sm:px-6 md:px-12 md:pl-72 text-xs border-t border-gray-200 dark:border-primary/10 border-dashed">
